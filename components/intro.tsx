      ...
      className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]">
        <div className="flex items-center justify-center">
            <div className='relative'>
                ...
                >
                    <Image src='/1.jpg' alt='Profile Picture' width="192" height='192' quality='95' priority={true}
        ...
        >
           ...
           href='https://drive.google.com/uc?export=download&id=1iZvY1COo_zsH4Y71fRgZJvsmsL6U31M1' download={true} >Download CV<HiDownload className='opacity-60 group-hover:translate-y-1 transition' /></a>
            ...
            href='https://www.linkedin.com/in/santoshnarala/' target='_blank'><BsLinkedin /></a>
            
            <a className='bg-white p-4 text-gray-700
            flex items-center gap-2 rounded-full outline-none text-[1.35rem] focus:scale-[1.15] hover:scale-[1.15] 
            hover:text-gray-950 active:scale-105 transition cursor-pointer border border-black/10 dark:bg-white/10 dark:text-white/60'
            href='https://github.com/santosh-narala/' target='_blank'><FaGithubSquare/></a>
        </motion.div>
    </section>
  )
}
